...
print('Выполнение на списке из 10 чисел', timeit('merge_sort(a)', globals=globals(), number=10000))

print('Выполнение на списке из 100 чисел', timeit('merge_sort(b)', globals=globals(), number=10000))
print('Выполнение на списке из 1000 чисел', timeit('merge_sort(c)', globals=globals(), number=10000))
